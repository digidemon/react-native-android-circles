...
public class CirclesManager extends SimpleViewManager <CircleProgressView> implements CircleProgressView.OnProgressChangedListener {
    ...
    public void setSeekModeEnabled(CircleProgressView view, boolean val) {
